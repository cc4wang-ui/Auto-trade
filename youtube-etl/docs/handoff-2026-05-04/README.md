...
| `current-state.md` | Deployed system snapshot — what's running, what's not | 1st |
...
| `dashboard-code.gs` | Apps Script for Connected Sheets dashboard | When dashboard needs rebuild |
...
- **6-tab Connected Sheets dashboard** functional (Talent / Manager / Top10 / Trend / Videos / Lives)
...
- Gotchas documented: 25 (#27-51 in `dev-guide.md` and copied here)
- PRs created: 1 (#14, draft, 8+ commits)
- Cloud Run revisions deployed: 4 (current = 00004)
- BQ tables populated: 6 raw + 4 mart
- Dashboard tabs: 6
- Total YouTube API quota burned today: 385 units (3.85% of 10K daily default)
