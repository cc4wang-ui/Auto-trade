...
| 用在哪 | Raw URL（長按複製） |
|---|---|
| GAS 主檔 | `https://raw.githubusercontent.com/cc4wang-ui/Auto-trade/claude/telegram-bot-workflows-9Xsus/macro_snapshot_handler.gs` |
| Pine snapshot snippet | `https://raw.githubusercontent.com/cc4wang-ui/Auto-trade/claude/telegram-bot-workflows-9Xsus/pine_alert_webhook.md` |
| Routine prompt | `https://raw.githubusercontent.com/cc4wang-ui/Auto-trade/claude/telegram-bot-workflows-9Xsus/macro_snapshot_prompt.md` |

> 💡 在 GitHub mobile app 開 PR #6 → Files changed → 任一檔右上角 ⋮ → View file → Raw（會跳到 raw.githubusercontent.com）。
